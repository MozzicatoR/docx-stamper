...
abstract class ExcelVisitor {
    ...
    public final void visit(@Nullable Object object) {
        before(object);
        try {
            if (object instanceof SpreadsheetMLPackage element) {
                visit(element.getParts());
            } else if (object instanceof Parts element) {
                visit(element.getParts());
            } else if (object instanceof WorksheetPart element) {
                visit(element.getContents());
            } else if (object instanceof WorkbookPart element) {
                visit(element.getContents());
            } else if (object instanceof DocPropsCorePart ignored) {
                ignore(ignored);
            } else if (object instanceof DocPropsExtendedPart ignored) {
                ignore(ignored);
            } else if (object instanceof Styles ignored) {
                ignore(ignored);
            } else if (object instanceof SharedStrings element) {
                visit(element.getContents());
            } else if (object instanceof ThemePart ignored) {
                ignore(ignored);
            } else if (object instanceof Workbook element) {
                visit(element.getSheets());
            } else if (object instanceof Sheets element) {
                visit(element.getSheet());
            } else if (object instanceof Worksheet element) {
                visit(element.getSheetData());
            } else if (object instanceof SheetData element) {
                visit(element.getRow());
            } else if (object instanceof Row element) {
                visit(element.getC());
            } else if (object instanceof Cell element) {
                visit(element.getIs());
            } else if (object instanceof CTRst element) {
                visit(element.getR());
            } else if (object instanceof CTSst element) {
                visit(element.getSi());
            } else if (object instanceof CTRElt element) {
                visit(element.getT());
            } else if (object instanceof CTXstringWhitespace ignored) {
                ignore(ignored);
            } else if (object instanceof JAXBElement<?> element) {
                visit(element.getValue());
            } else if (object instanceof Sheet element) {
                visit(element.getState());
            } else if (object instanceof STSheetState ignored) {
                ignore(ignored);
            ...
            } else if (object instanceof Entry<?, ?> element) {
